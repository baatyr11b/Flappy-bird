...
public class Game extends Application {
    ...
    private Random rnd;
    private Music boomSound, scoreSound;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        rnd = new Random();
        boomSound = new Music("resources/music/crush.mp3");
        scoreSound = new Music("resources/music/score.mp3");
        ...
        KeyFrame kf = new KeyFrame(Duration.seconds(0.017), (ActionEvent e) -> {
